...
from .views import (
    ...
    MediaSectionListCreateView,
    MediaSectionDetailView,
    MediaSectionReorderView,
...
urlpatterns = [
    ...
    path('businesses/<slug:path>/sections/reorder/', MediaSectionReorderView.as_view()),
    path('businesses/<slug:path>/sections/', MediaSectionListCreateView.as_view()),
    path('sections/<int:pk>/', MediaSectionDetailView.as_view()),
    ...
    path('nfc/orders/<int:pk>/pay/', NfcOrderPayView.as_view()),
    ...
    path('public/offer.pdf', OfferPdfView.as_view()),
